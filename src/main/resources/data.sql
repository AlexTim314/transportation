...
insert into Department (shortname, fullname, address, phone) values('ЦИП ИК', 'Центр испытаний и применения измерительного комплекса', null, null);
    insert into Route_Template(name, department_id) values('ИП-1 пл. 18 (Ежедневно)', currval('department_id_seq'));
        ...
        insert into Route_Task(work_name, order_num, place_id) values('Перевозка пассажиров - 50 чел.', 1, (select id from Place where name='Пл. 18'));
        insert into route_template_route_tasks(route_template_id, route_tasks_id) values(currval('route_template_id_seq'), currval('route_task_id_seq'));
    ...
    insert into Route_Template(name, department_id) values('ИП-2 пл. 44 (Ежедневно)', currval('department_id_seq'));
        ...
        insert into route_template_route_tasks(route_template_id, route_tasks_id) values(currval('route_template_id_seq'), currval('route_task_id_seq'));
        insert into Route_Task(work_name, order_num, place_id) values('Перевозка пассажиров - 50 чел.', 1, (select id from Place where name='Пл. 44'));
        insert into route_template_route_tasks(route_template_id, route_tasks_id) values(currval('route_template_id_seq'), currval('route_task_id_seq'));
        insert into Route_Task(work_name, order_num, place_id) values('Перевозка пассажиров - 50 чел.', 2, (select id from Place where name='Пл. 10'));
        insert into route_template_route_tasks(route_template_id, route_tasks_id) values(currval('route_template_id_seq'), currval('route_task_id_seq'));
    insert into Route_Template(name, department_id) values('ИП-3 пл. 97 (Ежедневно)', currval('department_id_seq'));
        ...
        insert into route_template_route_tasks(route_template_id, route_tasks_id) values(currval('route_template_id_seq'), currval('route_task_id_seq'));
        insert into Route_Task(work_name, order_num, place_id) values('Перевозка пассажиров - 50 чел.', 1, (select id from Place where name='Пл. 97'));
        insert into route_template_route_tasks(route_template_id, route_tasks_id) values(currval('route_template_id_seq'), currval('route_task_id_seq'));
        insert into Route_Task(work_name, order_num, place_id) values('Перевозка пассажиров - 50 чел.', 2, (select id from Place where name='Пл. 10'));
        insert into route_template_route_tasks(route_template_id, route_tasks_id) values(currval('route_template_id_seq'), currval('route_task_id_seq'));
